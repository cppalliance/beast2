...
#define BOOST_BEAST2_TEST_STREAM_HPP
...
/** A two-way socket useful for unit testing
    ...
    @ref boost::beast2::http::async_write for example.
    ...
    @li The input area, represented by a @ref beast2::basic_flat_buffer,
...
public:
    ...
    */
    template <class ExecutionContext,
        class = typename std::enable_if<
            std::is_convertible<ExecutionContext&, asio::execution_context&>::value>::type>
    explicit
    ...
    */
    ...
    /** Start an asynchronous read.
        ...
        @code
        void handler(
            system::error_code const& ec,           // Result of operation.
...
template<class Executor>
void
beast2_close_socket(basic_stream<Executor>& s)
{
    s.close();
}
#endif
